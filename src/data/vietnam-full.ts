    ...
    "districts": [
      ...
      },
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Mường Sang",
            "code": "04027"
          },
          {
            "name": "Phường Đông Sang",
            "code": "04030"
          },
          {
            "name": "Phường Vân Sơn",
    ...
    "districts": [
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Dĩnh Trì",
            "code": "07441"
          },
          {
            "name": "Phường Nham Biền",
            "code": "07681"
          },
          {
            "name": "Phường Tân An",
          ...
          {
            "name": "Phường Song Khê",
            "code": "07705"
          },
          {
            "name": "Phường Nội Hoàng",
            "code": "07708"
          },
          {
      ...
      },
      {
        ...
        "wards": [
          ...
          {
            "name": "Thị trấn Biển Động",
            "code": "07573"
          },
          {
            "name": "Thị trấn Phì Điền",
            "code": "07582"
          },
          {
            "name": "Xã Tân Quang",
    ...
    "districts": [
      ...
      },
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Thuỷ Đường",
            "code": "11560"
          },
          {
            "name": "Phường Hoàng Lâm",
            "code": "11569"
          },
          {
            "name": "Phường Hoa Động",
            "code": "11572"
          },
          {
    ...
    "districts": [
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Hoằng Quang",
            "code": "15925"
          },
          {
            "name": "Phường Hoằng Đại",
            "code": "15970"
          },
          {
            "name": "Phường Rừng Thông",
            "code": "16378"
          },
          {
            "name": "Xã Đông Hoàng",
    ...
    "districts": [
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Nghi Phú",
            "code": "16702"
          },
          {
            "name": "Phường Hưng Đông",
            "code": "16705"
          },
          {
            "name": "Phường Hưng Lộc",
    ...
    "districts": [
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Thạch Hạ",
            "code": "18100"
          },
          {
            "name": "Phường Đồng Môn",
            "code": "18103"
          },
          {
            "name": "Phường Thạch Hưng",
            "code": "18109"
          },
          {
            "name": "Xã Thạch Bình",
    ...
    "districts": [
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Thủy Bằng",
            "code": "19981"
          },
          {
            "name": "Phường Hương Phong",
            "code": "20002"
          }
        ]
      },
      ...
      },
      {
        ...
        "wards": [
          ...
          {
            "name": "Phường Phong Hòa",
            "code": "19846"
          },
          {
            "name": "Phường Phong Hiền",
            "code": "19852"
          },
          {
            "name": "Xã Phong Mỹ",
...
export function getProvinces(): { name: string; code: string }[] {
  return vietnamProvinces.map(p => ({ name: p.name, code: p.code }));
}

export function getDistricts(provinceCode: string): { name: string; code: string }[] {
  const province = vietnamProvinces.find(p => p.code === provinceCode);
  return province ? province.districts.map(d => ({ name: d.name, code: d.code })) : [];
}

export function getWards(provinceCode: string, districtCode: string): { name: string; code: string }[] {
  const province = vietnamProvinces.find(p => p.code === provinceCode);
  if (!province) return [];
  const district = province.districts.find(d => d.code === districtCode);
  return district ? district.wards.map(w => ({ name: w.name, code: w.code })) : [];
}