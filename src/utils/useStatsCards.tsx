...
/**
 * Hook để tạo stats cards một cách dễ dàng
 *
 * @example
 * const { StatsCard } = useStatsCards();
 *
 * const stats = [
 *   { title: 'Tổng người dùng', value: 1234, icon: Users, color: 'blue' },
 *   { title: 'Đơn hàng', value: 567, icon: Package, color: 'green' }
 * ];
 *
 * return (
 *   <div className="grid grid-cols-4 gap-6">
 *     {stats.map((stat, i) => <StatsCard key={i} config={stat} />)}
 *   </div>
 * );
 */
