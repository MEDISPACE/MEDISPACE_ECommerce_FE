    ...
    switch (code) {
      case 'PAYMENT_FAILED':
        return {
          ...
          description:
            'Giao dịch thanh toán của bạn không thể hoàn tất. Vui lòng kiểm tra thông tin thanh toán và thử lại.',
          suggestions: [
      ...
      case 'PRESCRIPTION_REQUIRED':
        return {
          title: 'Cần đơn thuốc',
          description:
            'Một số sản phẩm trong đơn hàng yêu cầu đơn thuốc từ bác sĩ. Vui lòng upload đơn thuốc trước khi đặt hàng.',
          suggestions: [
  ...
  return (
    <div className='max-w-4xl mx-auto px-4 py-12'>
      ...
      <div className='text-center mb-8 animate-slide-in-up'>
        ...
        <p className='text-xl text-gray-600 max-w-2xl mx-auto'>{errorDetails.description}</p>
      </div>
      ...
      <Alert className='mb-6 border-2 border-orange-200 bg-orange-50 animate-slide-in-up'>
        <AlertDescription className='text-orange-800'>
          ...
          <span className='text-sm'>
            Vui lòng cung cấp mã lỗi này khi liên hệ với bộ phận hỗ trợ để được giúp đỡ nhanh hơn.
          </span>
        </AlertDescription>
      </Alert>
      ...
      <div className='flex flex-col sm:flex-row gap-4 justify-center mb-8 animate-fade-in'>
        ...
        <Button asChild variant='outline' className='border-2 border-gray-300 text-gray-700 hover:bg-gray-50'>
      ...
      <Card className='bg-gradient-to-r from-[#F8FAFB] to-[#F0F6FF] border border-[#BFDBFE] animate-slide-in-up'>
        ...
        <CardContent className='space-y-4'>
          <p className='text-gray-700'>
            Đội ngũ hỗ trợ của MEDISPACE luôn sẵn sàng giúp đỡ bạn. Chúng tôi có thể giải quyết vấn đề của bạn qua các
            kênh sau:
          </p>
