...
import { mockUser, mockOrders, mockNotifications } from '../../utils/mockAccountData'
      ...
      <div className='space-y-6'>
        ...
        <div className='text-center md:text-left'>
          <h1 className='text-2xl font-bold text-blue-800 mb-2'>
            Chào mừng trở lại, {mockUser.firstName} {mockUser.lastName}! 👋
          </h1>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-orange-600'>{mockUser.loyaltyPoints.toLocaleString()}</p>
                </div>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-green-600'>{formatPrice(mockUser.totalSaved)}</p>
                </div>
