            ...
            <div className="space-y-6">
                ...
                <Tabs value={selectedTab} onValueChange={setSelectedTab} className="space-y-6">
                    <TabsList className='inline-flex w-full overflow-x-auto bg-blue-100 p-1 rounded-lg shadow-sm scrollbar-hide'>
                        ...
                        <TabsTrigger value="pending" className='flex-shrink-0 text-xs md:text-sm px-3 md:px-4 py-2.5 bg-blue-100 text-blue-600 border-0 data-[state=active]:!bg-blue-600 data-[state=active]:!text-white data-[state=active]:shadow-md transition-all duration-200 rounded-md hover:bg-blue-200'>
                            <span className='whitespace-nowrap flex items-center gap-1'>
                                Chờ duyệt ({getStatusCount(ReviewStatus.Pending)})
                            </span>
                        </TabsTrigger>
                        <TabsTrigger value="approved" className='flex-shrink-0 text-xs md:text-sm px-3 md:px-4 py-2.5 bg-blue-100 text-blue-600 border-0 data-[state=active]:!bg-blue-600 data-[state=active]:!text-white data-[state=active]:shadow-md transition-all duration-200 rounded-md hover:bg-blue-200'>
                            <span className='whitespace-nowrap flex items-center gap-1'>
                                Đã đăng ({getStatusCount(ReviewStatus.Approved)})
                            </span>
                        </TabsTrigger>
                        <TabsTrigger value="rejected" className='flex-shrink-0 text-xs md:text-sm px-3 md:px-4 py-2.5 bg-blue-100 text-blue-600 border-0 data-[state=active]:!bg-blue-600 data-[state=active]:!text-white data-[state=active]:shadow-md transition-all duration-200 rounded-md hover:bg-blue-200'>
                            <span className='whitespace-nowrap flex items-center gap-1'>
