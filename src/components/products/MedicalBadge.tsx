...
export function MedicalBadge({ type, size = 'md', showIcon = true, className = '', children }: MedicalBadgeProps) {
...
export function MedicalBadgeLight({ type, size = 'md', showIcon = true, className = '', children }: MedicalBadgeProps) {
  const config = badgeConfig[type]
  const sizeStyles = sizeConfig[size]
  const IconComponent = config.icon
...
export const RxBadge = (props: Omit<MedicalBadgeProps, 'type'>) => <MedicalBadge type='rx' {...props} />

export const OTCBadge = (props: Omit<MedicalBadgeProps, 'type'>) => <MedicalBadge type='otc' {...props} />

export const ConsultationBadge = (props: Omit<MedicalBadgeProps, 'type'>) => (
  <MedicalBadge type='consultation' {...props} />
)

export const PharmacyBadge = (props: Omit<MedicalBadgeProps, 'type'>) => <MedicalBadge type='pharmacy' {...props} />
