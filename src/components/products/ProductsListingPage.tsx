                  ...
                  <div className='flex items-center justify-between mb-6 p-4 bg-white rounded-lg border border-blue-100'>
                    ...
                    <div className='flex items-center border border-blue-200 rounded-lg overflow-hidden'>
                      <Button
                        ...
                        className={viewMode === 'grid' ? 'bg-blue-600 text-white hover:bg-blue-700 hover:text-white' : 'text-gray-600'}
                      >
                      ...
                      <Button
                        ...
                        className={viewMode === 'list' ? 'bg-blue-600 text-white hover:bg-blue-700 hover:text-white' : 'text-gray-600'}
                      >
