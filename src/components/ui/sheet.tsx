  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          '!bg-white text-gray-900 [color-scheme:light] data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[110] flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 scrollbar-thin',
          side === 'right' &&
