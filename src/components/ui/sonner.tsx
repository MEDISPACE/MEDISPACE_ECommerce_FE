    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          info: 'group-[.toaster]:bg-gradient-to-br group-[.toaster]:from-blue-50/95 group-[.toaster]:to-cyan-50/95 group-[.toaster]:border-blue-400 group-[.toaster]:text-blue-900',

          // Default toast - MEDISPACE blue theme
          default:
            'group-[.toaster]:bg-gradient-to-br group-[.toaster]:from-blue-50/95 group-[.toaster]:to-white/95 group-[.toaster]:border-blue-200 group-[.toaster]:text-gray-900',

          title: 'group-[.toast]:font-semibold group-[.toast]:text-base',
          description: 'group-[.toast]:text-sm group-[.toast]:opacity-90',
          actionButton:
            'group-[.toast]:bg-blue-600 group-[.toast]:text-white group-[.toast]:hover:bg-blue-700 group-[.toast]:px-4 group-[.toast]:py-2 group-[.toast]:rounded-lg group-[.toast]:font-medium group-[.toast]:transition-all',
          cancelButton:
