                      ...
                      <div className='space-y-4'>
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(val) => handleChange('smsProvider', val)}
                          >
                            <SelectTrigger className='border-2 border-blue-200 focus:border-blue-500'>
                              <SelectValue />
                            </SelectTrigger>
                  ...
                  <div className='p-4 border border-blue-200 rounded-lg'>
                    <div className='flex items-center justify-between'>
                      ...
                      <Switch
                        ...
                        onCheckedChange={(val) => handleChange('codEnabled', val)}
                      />
                    </div>
                  </div>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='p-4 border border-blue-200 rounded-lg'>
                    <div className='flex items-center justify-between mb-3'>
                      ...
                      <Switch
                        checked={settings.ghnEnabled}
                        onCheckedChange={(val) => handleChange('ghnEnabled', val)}
                      />
                    </div>
                    {settings.ghnEnabled && (
                      <div className='space-y-3'>
