...
export function BrandManagementPage() {
    ...
    const filteredBrands = useMemo(() => {
        return brandsData.filter((brand) => {
            ...
            const matchesCountry =
                filterCountry === 'all' || brand.country === filterCountry
    ...
    const countries = useMemo(() => {
        const countrySet = new Set(
            brandsData.map((brand) => brand.country).filter(Boolean)
        )
                    ...
                    <CardContent className='p-4'>
                        <div className='flex items-center justify-between'>
                            <div>
                                ...
                                <p className='text-2xl font-semibold text-[#4A90E2]'>
                ...
                <FormSection title='Thông tin cơ bản'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <Popover open={countryComboboxOpen} onOpenChange={setCountryComboboxOpen}>
                            ...
                            <PopoverContent className='w-[608px] p-0 bg-white border-2 border-blue-200 shadow-lg z-[9999]' align='start'>
                                    ...
                                    <CommandList className='max-h-[200px] overflow-y-auto'>
                                        <CommandEmpty>
                                            <div className='p-2 text-sm text-gray-500'>
                                                Nhấn Enter để thêm quốc gia mới
                                            </div>
                                        </CommandEmpty>
                ...
                <FormSection title='Hình ảnh'>
                    ...
                    <div className='flex gap-2 mb-4'>
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${logoMode === 'url'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${logoMode === 'upload'
                                ? 'bg-blue-100 text-blue-700 border border-blue-300'
                                : 'bg-gray-100 text-gray-600 border border-gray-200 hover:bg-gray-200'
                                }`}
                        >
