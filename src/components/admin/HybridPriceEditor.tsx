...
export function HybridPriceEditor({ variants = [], onChange, disabled = false }: HybridPriceEditorProps) {
    ...
    const validateVariant = (): boolean => {
        ...
        if (!editingVariant.unit) {
            ...
            variants.some(v => v.unit === editingVariant.unit)
        ) {
        ...
        <div className='space-y-4'>
            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent className='sm:max-w-md'>
                    <DialogHeader>
                        <DialogTitle>
                            {editingVariant?.index !== undefined ? 'Sửa đơn vị' : 'Thêm đơn vị'}
                        </DialogTitle>
                        <DialogDescription>
                            Nhập thông tin đơn vị và giá cho sản phẩm
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className='space-y-4 py-4'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <Select
                                ...
                                onValueChange={(value) =>
                                    setEditingVariant(prev => prev ? { ...prev, unit: value } : null)
                                }
