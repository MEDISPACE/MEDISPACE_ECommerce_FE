    ...
    <div className='max-w-7xl mx-auto px-4 py-12 space-y-16'>
        ...
        <div className='grid md:grid-cols-2 gap-12 items-center'>
          <div className='space-y-6 animate-slide-in-left'>
            ...
            <p className='text-gray-700 leading-relaxed'>
              Được thành lập từ năm 2010, MEDISPACE bắt đầu từ một cửa hàng nhỏ tại TP. Hồ Chí Minh với khát vọng mang
              đến dịch vụ chăm sóc sức khỏe chất lượng cao cho người Việt.
            </p>
            <p className='text-gray-700 leading-relaxed'>
        ...
        <div className='bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-12 text-center space-y-6'>
          ...
          <p className='text-gray-700 max-w-3xl mx-auto leading-relaxed'>
            MEDISPACE tự hào sở hữu đội ngũ dược sĩ, bác sĩ và chuyên viên y tế có trình độ chuyên môn cao, nhiều năm
            kinh nghiệm, luôn tận tâm chăm sóc và tư vấn cho khách hàng.
          </p>
