...
import { Package, RotateCcw, FileText, ImageIcon, CheckCircle, XCircle, X, ChevronLeft, ChevronRight, User, Wallet } from 'lucide-react'
                            ...
                            <CardContent>
                                <div className="bg-gradient-to-br from-yellow-50 to-amber-50 p-4 rounded-xl border border-yellow-200">
                                    ...
                                    {request.reasonDetail && (
                                        <p className="text-gray-700 mt-2 italic">"{request.reasonDetail}"</p>
                                    )}
                                </div>
                            </CardContent>
                        </Card>
